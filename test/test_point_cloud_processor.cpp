...
geometry_msgs::msg::TransformStamped makeTransform(double x, double y, double z)
{
  ...
  transform.header.frame_id = "local_map_lidar_init";
...
TEST(PointCloudProcessor, TransformsAndAppliesHeightRangeAndFootprintFilters)
{
  ...
  config.planning_frame = "local_map_lidar_init";
  ...
  EXPECT_EQ(result.filtered_cloud.header.frame_id, "local_map_lidar_init");
