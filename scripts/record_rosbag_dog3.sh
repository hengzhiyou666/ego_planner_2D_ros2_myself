...
location_publishers="$(publisher_count /lidar_location_now)"
...
echo "雷达定位全局位姿 /lidar_location_now：${location_publishers} 个发布者"
